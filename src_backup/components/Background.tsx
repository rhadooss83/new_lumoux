...
const BUBBLE_COLORS = [
  "71, 85, 105",    // Slate 600 (Muted grayish blue)
  "51, 65, 85",     // Slate 700 (Darker slate)
  "63, 63, 70",     // Zinc 700 (Muted gray)
  "75, 85, 99",     // Gray 600
  "49, 46, 129",    // Indigo 900 (Deep shadowy blue/purple)
  "23, 37, 84",     // Blue 950 (Very dark blue)
  "88, 28, 135",    // Purple 900 (Deep shadowy purple)
];
...
export default function Background() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-black">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-zinc-900/60 via-black to-black" />
      {bubbles.map((bubble) => (
