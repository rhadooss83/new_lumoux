...
const ServiceCard: React.FC<{ service: typeof services[0], index: number, isServicesPage: boolean }> = ({ service, index, isServicesPage }) => {
  ...
  return (
    <motion.div
      ...
      className={`rounded-[2rem] border border-white/10 bg-black p-6 md:p-8 h-full flex flex-col items-center text-center transition-all duration-300 shadow-[0_0_15px_rgba(168,85,247,0.2)] hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] ${isServicesPage ? '' : 'hover:scale-[1.02]'}`}
    >
...
export default function Services() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-16 md:py-20 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full max-w-sm md:max-w-none mx-auto">
      ...
      {isServicesPage && (
        <motion.div
          ...
          className="mt-12 md:mt-16 w-full max-w-3xl rounded-[2rem] border border-white/10 bg-black p-6 md:p-10 text-center shadow-[0_0_15px_rgba(255,255,255,0.05)]"
        >
